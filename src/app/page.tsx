...
export default function Home() {
  const homeBlogSlides = [...blogPosts, ...blogPosts, ...blogPosts].map((post, index) => (
          ...
          <div className="loading-container">
            <div id="loading-icon">
              <svg id="icon-cctv" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60.051 60.051">
                ...
                <circle className="led-blink-1" cx="28.051" cy="27.026" r={1} />
                <circle className="led-blink-2" cx="24.051" cy="27.026" r={1} />
              </svg>
            </div>
          </div>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="service-header heading6">
                    ...
                    <p data-aos="fade-left" data-aos-duration={1000} data-aos-delay={400}>With advanced technology, 24/7 surveillance capabilities personalized <br className="d-lg-block d-none" /> service, we're committed to safeguarding what matters most to you.</p>
                  </div>
                </div>
              </div>
              <div className="row">
                    ...
                    <div className="service-boxarea">
                      ...
                      <div className="content-area">
                        ...
                        <div className="content-area-pera">
                          ...
                          <a href="#service" className="readmore">Learn More <i className="fa-solid fa-arrow-right" /></a>
                        </div>
                      </div>
                    </div>
                    <div className="service-boxarea">
              ...
              <div className="row">
                <div className="col-lg-5">
                  <div className="testimonial-header heading5">
                    ...
                    <h2 className="text-anime-style-3">Stories Hear From Our Clients</h2>
                ...
                <div className="col-lg-12" data-aos="fade-up" data-aos-duration={1000} data-aos-delay={600} data-aos-offset={40}>
                  <div className="testimonial-author-slider owl-carousel">
                    <div className="testimonial-author-box">
                      ...
                      <ul>
                        <li><a href="#"><i className="fa-solid fa-star" /></a></li>
                        <li><a href="#"><i className="fa-solid fa-star" /></a></li>
                        <li><a href="#"><i className="fa-solid fa-star" /></a></li>
                        <li><a href="#"><i className="fa-solid fa-star" /></a></li>
                        <li><a href="#"><i className="fa-solid fa-star" /></a></li>
                      ...
                      <p>“From prompt and professional service to reliable <br className="d-lg-block d-none" /> surveillance systems, our clients consistently praise our <br className="d-lg-block d-none" /> expertise, reliability, &amp; dedication to their safety security”</p>
                    </div>
                    <div className="testimonial-author-box">
                      <div className="images">
                        <div className="content">
                      ...
                      <div className="space16" />
                      <p>“Take a moment to read through their testimonials <br className="d-lg-block d-none" /> below and discover why Your Company Name is the <br className="d-lg-block d-none" /> trusted choice for all your security needs”</p>
                    </div>
                    <div className="testimonial-author-box">
                      <div className="images">
                        <div className="content">
                      ...
                      <div className="space16" />
                      <p>“See what our satisfied customers have to say about <br className="d-lg-block d-none" /> their experiences with Our commitment to providing top-notch <br className="d-lg-block d-none" /> security and CCTV solutions has earned us rave”</p>
                    </div>
                    <div className="testimonial-author-box">
                      <div className="images">
                        <div className="content">
